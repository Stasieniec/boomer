...
# We set some globals and define a function for consistent logging
...
# Create left and right frames; note that they are first assigned to a
# variable so that they can be referenced later and assigning them sizes
# would be pointless as the grid manager set their sizes such that their
# contents fit!
...
Label(left_frame, text = "Some controls", relief = SUNKEN).grid(
    row = 0,
    column = 0,
    padx = 5,
    pady = 5
...
Label(tool_bar, text = "Colors", relief = SUNKEN).grid(
    row = 0,
    column = 0,
    padx = 5,
    pady = 3,
...
Label(tool_bar,  text = "Cursors",  relief = SUNKEN).grid(
    row = 0,
    column = 1,
    padx = 5,
    pady = 3,
